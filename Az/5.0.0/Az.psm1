...
#
# Generated on: 10/23/2020 03:26:02
#
...
Import-Module Az.Aks -RequiredVersion 2.0.0 -Global
...
Import-Module Az.Compute -RequiredVersion 4.6.0 -Global
Import-Module Az.ContainerInstance -RequiredVersion 1.0.3 -Global
Import-Module Az.ContainerRegistry -RequiredVersion 2.0.0 -Global
Import-Module Az.DataBoxEdge -RequiredVersion 1.1.0 -Global
Import-Module Az.Databricks -RequiredVersion 1.0.1 -Global
Import-Module Az.DataFactory -RequiredVersion 1.11.0 -Global
...
Import-Module Az.DesktopVirtualization -RequiredVersion 2.0.0 -Global
...
Import-Module Az.EventHub -RequiredVersion 1.7.0 -Global
Import-Module Az.FrontDoor -RequiredVersion 1.6.1 -Global
Import-Module Az.Functions -RequiredVersion 2.0.0 -Global
Import-Module Az.HDInsight -RequiredVersion 4.0.0 -Global
Import-Module Az.HealthcareApis -RequiredVersion 1.1.0 -Global
Import-Module Az.IotHub -RequiredVersion 2.6.0 -Global
Import-Module Az.KeyVault -RequiredVersion 3.0.0 -Global
...
Import-Module Az.Monitor -RequiredVersion 2.2.0 -Global
Import-Module Az.Network -RequiredVersion 4.1.0 -Global
...
Import-Module Az.RecoveryServices -RequiredVersion 3.0.0 -Global
Import-Module Az.RedisCache -RequiredVersion 1.4.0 -Global
Import-Module Az.Relay -RequiredVersion 1.0.3 -Global
Import-Module Az.Resources -RequiredVersion 3.0.0 -Global
...
Import-Module Az.Sql -RequiredVersion 2.11.1 -Global
Import-Module Az.SqlVirtualMachine -RequiredVersion 1.1.0 -Global
Import-Module Az.Storage -RequiredVersion 3.0.0 -Global
...
Import-Module Az.Websites -RequiredVersion 2.0.0 -Global
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBAVWIqaJXoTy1g
# 53fYnhuy6dUwDNeehjM9FtQ5iPKis6CCDYEwggX/MIID56ADAgECAhMzAAABh3IX
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgT3aorWHT
# +wMZAcP8BP2TRI9W7OC/36Gl5GgbrN0FpFowQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQA8X4nRRkiHeJYZ2eZ8UQ3uYIB9En8+3DEzFKCuv4MK
# t51m74BcyXXzU9vp3J2xcPAcAK/03QqBICWfupwKStcvcGYlsdKSLC9HVumbIbPO
# xfzQ19aLOUczQ3YLbnx0PaDy1AsrWFHRLZ0RlXhKVmde3gpX1kfG7294W1HckBTw
# 8+4M1nAtY/m28wXuFTh9MD8Hjc5shywncl+dRCr6mx0li/TM2g0FnRkBoiJXPGF8
# kak5F7SCKDkhaxDDDJ1rYuM66MlSkseBJ6SQ0/Mwk7YyIdZ+Jo1gtrlFDZlnKVNV
# fCQV8sv5nKmZXUEY9XjOuB0ugH89ojuh/DOoLni7kGDBoYIS7jCCEuoGCisGAQQB
# gjcDAwExghLaMIIS1gYJKoZIhvcNAQcCoIISxzCCEsMCAQMxDzANBglghkgBZQME
# AgEFADCCAVUGCyqGSIb3DQEJEAEEoIIBRASCAUAwggE8AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIGluFQtQRRvhYX1K343NZRDKNDOouUOq1ojEXX7D
# 42ujAgZfiHglnAoYEzIwMjAxMDIzMDM1NTE5LjcxMVowBIACAfSggdSkgdEwgc4x
...
# IgQgnNEFY+p1s/CVaBR/CI3ktwqcHlzKVlHSi7WIM9P06rswgfoGCyqGSIb3DQEJ
...
# MA0GCSqGSIb3DQEBCwUABIIBAHTgBuLf73UqY059GXs+2yACko8HxqFEAVp4cR+/
# 25HvcnBR9D0EDm44Kx1hq0NugBzHfYiSJekQB0ufq6lrVe1nVR1wRDqkjeFLYx54
# hQCDGMExHEyxKRGsqXjQPkxZxw4bs1F+KfNpKeV3Hn4tUICVOIJYUjgcALGYr5+I
# aYkqzc4/K7QYRM+wawtxbOnTeXJmi6PS6DTCfWOrIqZsPkXrrceiDPjEm1hHRiH4
# Fi864OqZ+u2TFr3eOj0eHX+rLxRrT1qbcWvgVHtqqjGCf69rMWUIA4ZVgTvb4Qcg
# YSPFTx7S+re5c6XOMqyEEwDMtXX1+7AU3RMRPvRYsqe5OUs=
